 ...
 */
final class Version20220303132435 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE education DROP user_id, CHANGE degree degree VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE univercity univercity VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
