 ...
 */
final class Version20220303102417 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE education ADD user_id INT DEFAULT NULL, ADD degree VARCHAR(255) NOT NULL, ADD year_of_passing DATE NOT NULL, ADD persantage INT NOT NULL, ADD univercity VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE education DROP user_id, DROP degree, DROP year_of_passing, DROP persantage, DROP univercity');
